...
CRITICAL)
        ...
        SOFT|HARD)
                ...
                /usr/bin/curl -X POST --user itoperator:redhat123. --data @${AUXFILE} https://faz-tower/api/v2/workflow_job_templates/"HTTP Remediate++ACME"/launch/ -k -H "Content-Type: application/json"
                        ;;
                esac
